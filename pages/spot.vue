    ...
    <v-layout align-center justify-center reverse >
		...
		<div class="w1200">
			<div class="mt10">
		      ...
		      <span class="fr">共<span class="orange">3150</span>件相关产品</span>
			</div>
			...
			<div class="mt20">
				...
				<ul class="Xhlist">
					<li>
						...
						<span style="width: 9%;">31分钟前</span><span class="orange" style="width: 11%;">¥10550</span>
						<span style="width: 13%;">
						   <v-flex xs12>
            <v-radio-group v-model="color" row>
              <v-radio
                v-for="(colorValue, i) in ['自提', '配送']"
                :key="i"
                :color="colorValue"
                :label="colorValue"
                :value="colorValue"
...
.orderPorList li{display: flex; background-color: #fbfcff; border-bottom: 1px solid #fff;}
...
.scTitle { margin-left: 20px; width: 95px;  color: #333;line-height: 50px;}
.pro_brand_list{margin-left: 15px;}
.pro_brand_list a{ line-height: 50px; color: #666;   white-space: nowrap;margin-right: 20px;}
