      ...
      <div class="w1200 whitebg bdccc" style="margin-top: 20px; margin-bottom: 40px;">
        ...
        <div class="" style="display: flex; justify-content: space-between;align-items: center; margin-left: 35px;">
          <ul class="DeliveryMethod mb20">
            ...
            <li @click="chooseDelieryType(1)" v-if="$store.state.common.sysConfig.IS_CAN_DELIVERY == 1"
        ...
        <div class="mt30 fs16 ml15" id="test1">
          ...
          <span class="gray fs14">（ 最后全部提货完成时间<span class="orangeFont">{{this.specialDetail.endTime}}</span>，逾期增加<span
              class="orangeFont">0.01%</span>的仓储费 ）</span>
        </div>
...
export default {
	...
	computed: {
		...
		totalAmountes: function () {
			return parseFloat(this.totalPrice) * parseInt(this.feedingInfo.availableNum)
		},
