        ...
        <ul class="planList">
          <li v-for="(items, index) in speciallist" :key="index">
            ...
            <div class="operatebtn">
              <div class="btn" style="font-size: 23px;font-weight: 600;" v-if="items.is_can_click==1"
                   @click="planOrder(items.id)">{{items.name}}
              </div>
              <div class="btn" style="font-size: 23px;font-weight: 600;background-color: gainsboro;" v-else>
                {{items.name}}
              </div>
            </div>
          </li>
