          ...
          <table class="listT mt10" border="" cellspacing="" cellpadding="">
            ...
            <tr class="detailTable" v-for="(item, index) in dataList" :key="index">
              ...
              <td class="operate" style="width: 10%;">
				...
				<div class="check mt5 blackFont" style="margin-left:15px;background-color: gainsboro;" v-else-if='item.status==0'  >查看详情</div>
				<div class="check mt5 blackFont" style="margin-left:15px;cursor: pointer;" v-else  @click="detailLog(item)">查看详情</div>
              </td>
            </tr>
            </tbody>
          </table>
