           ...
           <table class="listT mt10" border="" cellspacing="" cellpadding="">
                    <tbody v-for="(item, index) in dataList" :key="index">
                        ...
                        <tr class="detailTable" >  
                            ...
                            <td class="operate">
                                <div class="mt5 blackFont"  style="width:100px;"   v-if='item.status==2'      >已入选</div>
                                <div class="mt5 blackFont"  style="width:100px;"   v-else-if='item.status==1' >已报价</div>
                                <div class="mt5 blackFont"  style="width:100px;"   v-else  >未入选</div>
                            </td>
                        </tr>
                    </tbody>
            </table>
