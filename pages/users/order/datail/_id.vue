      ...
      <div class="memberInfor ml20 mt20">
        ...
        <div class="whitebg" style="padding:0px 18px 18px;">
          ...
          <div style="line-height:32px;">
             <Row index="">
              <Col span="12"><a :href="`/users/plan/spot/${this.datalist.sourceId}`" class="mt5 blackFont">合约编号：{{this.datalist.sourceSn}}</a></Col>
     ...
     <div  class="whitebg mt20" style="padding:0px 18px 18px;">
          ...
          <div style="line-height:32px;">
            <Row index="" style="font-weight: bold;">
              ...
              <Col span="12">联系电话：<span v-if="this.datalist.memberPhone">{{this.datalist.memberPhone}}</span><span v-else>--</span></Col>
            </Row>
            <Row index="">
              <Col span="12">运输方式：<span v-if="this.datalist.transportationMode">{{this.datalist.transportationMode}}</span><span v-else>--</span></Col>
        ...
        <div class="whitebg mt20" style="padding:0px 18px 18px;">
          ...
          <div style="line-height:32px; ">
            <Row index="" style="background: #fafafa;line-height: 42px;text-align: center; border-bottom: 1px solid #eee;font-weight: bold;">
              <Col span="4">产品</Col>
              <Col span="2">数量</Col>
              <Col span="3">商品单价</Col>
              <Col span="2">运费</Col>
