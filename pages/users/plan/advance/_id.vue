    ...
    <div class="w1200 dflex " style="margin-bottom: 40px">
      ...
      <div class="memberInfor ml20 mt20">
        ...
        <div class="whitebg" style="padding:0px 18px 18px;">
          <h3 class="fs16 " style="line-height: 46px; border-bottom: 1px solid #ddd;">预售合约详情 <span
              v-if="dataInfo.available_num > 0 && dataInfo.status == 1" style="float:right;color:red; font-size:16px;">转单倒计时： <TimeDown formatStr="{D}天{H}时{M}分{S}秒" :endTime="dataInfo.last_ordered_date" endMsg="已失效"></TimeDown></span>
          </h3>
