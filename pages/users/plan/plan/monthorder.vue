<template>
  <div>
    <Table size="small" border stripe :loading="loading" highlight-row :columns="sourcecolumns" :data="datalist"
           :content="self">
...
export default {
	...
	data() {
		return {
			...
			selectFeedingData: [],
			sourcecolumns: [
				{title: '商品信息', width: '150', align: 'center', key: 'skuName'},
				{title: '单价（元/吨）', width: '120', key: 'finalPriceFormat'},
				{title: '数量（吨）', width: '100', align: 'center', key: 'orderNum',},
				{title: '库区', width: '150', align: 'center', key: 'warehouseName'},
				{title: '提货方式', width: '100', align: 'center', slot: 'isDelivery', key: 'isDelivery'},
				{title: '订单总金额', width: '120', key: 'totalAmountFormat'},
				{title: '付款状态', width: '150', slot: 'status', key: 'status'},
			]
		}
	},
	methods: {
