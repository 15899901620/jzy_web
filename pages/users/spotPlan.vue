              ...
              <tr class="detailTable">
                ...
                <td style="width: 15%;" class="operate">
                  ...
                  <div v-if="item.status != 3 && item.total_num > 0">
                    ...
                    <a v-else-if="item.contract_apply_status == 1 || item.contract_apply_status == 4" class="Paybtn CarCurr" style="padding: 3px 6px" @click="toShowApplyContract(item.id)">电子盖章</a>
