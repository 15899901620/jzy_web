...
export default {
  ...
  methods: {
    verifyReturn() {
      ...
      sendHttp(this, false, server.api.seal.signReturnUrl, {'transaction_id':transaction_id,'result_code':result_code,'result_desc':result_desc,'download_url':download_url,'viewpdf_url':viewpdf_url,'timestamp':timestamp,'msg_digest':msg_digest}).then(response => {
