        ...
        <div class="container" title="">
          ...
          <div class="Pages">
            <div class="j_news_wrap">
              <div class="j_news_l">
                <h2 class="j_t"><i>公司动态</i><span><nuxt-link :to="{name:'article-id', params:{id:6}}" >更多></nuxt-link></span></h2>
                <div class="j_n_pt" v-if="$store.state.article.articleList.length>0">

                  <div class="j_n_pic">
                    <img :src="$store.state.article.articleList[0].image" width="299" height="197" />
                ...
                <div class='j_n_pt'>
                  <div class="j_n_pic" v-if="$store.state.article.articleList2.length>0">
                ...
                <div class="j_n_pt">
                  <div class="j_n_info"   v-if="$store.state.article.noticeInfo1.length>0">
                     <h3 class="fwb">招标公告</h3>
                    <ul class="j_n_info_l" style="margin-top: 5px;">
              ...
              <div  class="j_news_r">
                <div  v-if="$store.state.article.articleList3.length>0">
                  <h2 class="j_t"><i>今日行情</i><span> <nuxt-link :to="{name:'article-id', params:{id:2}}" >更多></nuxt-link></span></h2>
                  <ul class="j_t_in" style="min-height:237px;" >
                ...
                <div class='mt20' v-if="$store.state.article.noticeInfo.length>0" style="min-height: 289px; overflow: hidden;">
                  <h2 class="j_t"><i>网站公告</i><span><nuxt-link :to="{name:'notice-list-page'}">更多></nuxt-link></span></h2>
                  <ul class="j_t_in">
                ...
                <div v-if="$store.state.article.articleList4.length>0">
                  ...
                  <ul class="j_t_in" style="min-height: 250px; overflow: hidden;" >
