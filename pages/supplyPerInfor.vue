        ...
        <ul class="dflexAlem Carinput" style=" margin-top: 23px; flex-direction: column;justify-content: center;">
          <li>
            <FormItem  prop="username">
              ...
              <input type="text" v-model="formSupplyInfor.username" class="CarrierIput" name="" id="" value="" placeholder="请输入公司名称" />
            </FormItem>
          </li>
          <li>
            <FormItem  prop="username">
              <span class="CarrierTitle" style="margin-left: -55px;"><i class="orangeFont mr5">*</i>纳税人识别号</span>
              <input type="text" class="CarrierIput" v-model="formSupplyInfor.username"  name="" id="" value="" placeholder="请输入纳税人识别号" />
            </FormItem>
          </li>
          <li>
            <FormItem  prop="username">
              <span class="CarrierTitle" style="margin-left: -14px;"><i class="orangeFont mr5">*</i>开户行</span>
              <input type="text" class="CarrierIput" v-model="formSupplyInfor.username" name="" id="" value=""  placeholder="请输入开户行" />
            </FormItem>
          </li>
          <li>
            <FormItem  prop="username">
              <span class="CarrierTitle"><i class="orangeFont mr5">*</i>账号</span>
              <input type="text" class="CarrierIput" v-model="formSupplyInfor.username" name="" id="" value="" placeholder="请输入账号" />
            </FormItem>
          </li>
          <li>
            <FormItem  prop="username">
              <span class="CarrierTitle"><i class="orangeFont mr5">*</i>地址</span>
              <input type="text" class="CarrierIput" v-model="formSupplyInfor.username"  name="" id="" value="" placeholder="请输入详细地址" />
            </FormItem>
          </li>
          <li>
            <FormItem  prop="username">
              <span class="CarrierTitle"><i class="orangeFont mr5">*</i>电话</span>
              <input type="text" class="CarrierIput"  v-model="formSupplyInfor.username" name="" id="" value=""  placeholder="请输入联系电话" />
            </FormItem>
          </li>
        </ul>
        ...
        <ul class="dflexAlem Carinput" style=" margin-top: 23px; flex-direction: column;justify-content: center;">
          ...
          <li>
            <FormItem  prop="username">
              ...
              <input type="text" v-model="formSupplyInfor.username" class="CarrierIput" name="" id="" value="" placeholder="请输入注册资金" />
            </FormItem>
          </li>
          <li>
          ...
          <li>
            ...
            <span class="CarrierTitle" style="margin-left: -60px;"><i class="orangeFont mr5">*</i>授权书</span>
