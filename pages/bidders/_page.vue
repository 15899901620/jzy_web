          ...
          <ul class="acuList" v-if="$store.state.bidders.auctionList.length >0">
            <li v-for="(items,index) in $store.state.bidders.auctionList" :key="index">
              <div class="acuProduct">
                <h1 class=" fs18">{{items.skuName}}</h1>
              ...
              <div class="acuOpear">
                <div style="display: flex; flex-direction: column; justify-content: flex-end">
                  ...
                  <span class="mt5">厂商：{{items.manufacturer}}</span>
                </div>
        ...
        <div class="acution" v-show="CurrSelect==1" style="display:none">
          <ul class="acuList" v-if="bidderssoonData.length >0">
            <li v-for="(items,index) in bidderssoonData" :key="index">
              ...
              <div class="acuOpear">
                <div
                    style=" width: 73%;  font-size: 15px;   display: flex; flex-direction: column; justify-content: center">
