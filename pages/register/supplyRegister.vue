<template>
    <div>
      ...
      <ul class="dflexAlem Carinput" style=" width: 537px; margin-top: 50px; flex-direction: column;justify-content: center;">
        <li>
          <span class="CarrierTitle" style="margin-left: -24px;"><i class="orangeFont mr5">*</i>手机号码</span>
          <FormItem prop="phone">
          <input type="text" class="CarrierIput" name="" id="" value="" placeholder="请输入手机号" />
          </FormItem>
        </li>
        <li><span class="CarrierTitle" style="margin-left: -24px;"><i class="orangeFont mr5">*</i>验证码</span>
          <FormItem>
        ...
        <li>
          <span class="CarrierTitle" style="margin-left: -22px;"><i class="orangeFont mr5">*</i>手机验证码</span>
          <FormItem>
        ...
        <li>
          ...
          <input type="password" class="CarrierIput"   v-model="formCustom.password"  name="" id="" value="" placeholder="请输入密码" />
          </FormItem>
        </li>
        <li>
          <FormItem prop="password">
          <span class="CarrierTitle"><i class="orangeFont mr5">*</i>确认密码</span>
          <input type="password" class="CarrierIput"  v-model="formCustom.repassword" name="" id="" value=""  placeholder="请再次输入密码" />
          </FormItem>
        </li>
      </ul>
...
<script>
    export default {
      ...
      // 下一步
        handleSubmit(){
          this.$router.push({path:'./supplyPerInfor'})
        },
        // 图片验证
        refreshpic(){
...
<style scoped>
  /*注册进度*/
  .CarrierTitle{width: 90px;text-align: right; color: #333; margin-right: 10px;}
  ...
  .Carinput li .CarrierIput{padding-left: 10px;box-sizing: border-box; width: 375px;border-radius: 3px;border: 1px solid #dddddd; height: 42px;line-height: 42px;}
   .CarrierRegister{margin-top: 30px;margin-bottom: 60px;margin-left: 13px; border-radius:3px;  cursor: pointer; font-size: 14px;
