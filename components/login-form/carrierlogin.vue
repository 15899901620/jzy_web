    ...
    <Form ref="loginsupplierform" :model="loginsupplierform" :rules="ruleCustom">
      ...
      <Row :gutter="24" index="">
        <Col span="24">
          <FormItem prop="slidecode">
            <slide-verify-carrier @onChange="onTime"></slide-verify-carrier>
          </FormItem>
        </Col>
      </Row>
      <Row :gutter="24" index="">
      ...
      <Row :gutter="24" index="">
        <Col span="12" style="text-align:left; margin:10px auto;">
          <nuxt-link to="/forgotpwd?type=carrier" >忘记密码</nuxt-link>
        </Col>
        <Col span="12" style="text-align:right; margin:10px auto;">
          <nuxt-link to="/register?type=carrier" >注册新账号</nuxt-link>
        </Col>
      </Row>
    </Form>
  </div>
...
export default {
  name: "supplylogin",
  components: {
    SlideVerifyCarrier: SlideVerify.carrier
  },
  data(){
