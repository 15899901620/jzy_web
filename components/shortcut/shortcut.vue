<template>
  <div :class="classes">
    <div class="TopPos" style="display: flex; position: relative;">
      ...
      <div style="position: absolute; right: -107px; "><a style="display: flex; align-items: center;" href="https://en.ejzy.cn/"><img src="../../static/img/english.png" height="15"/><span class="ml5">English</span> </a></div>
    </div>
  </div>
</template>
<script>
