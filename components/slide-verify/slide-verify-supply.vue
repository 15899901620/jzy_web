...
export default {
  ...
  methods: {
    ...
    successFunction(){
      ...
      document.getElementsByClassName('handler1')[0].style.left = this.maxwidth + 'px';
      document.getElementsByClassName('drag_bg1')[0].style.width = this.maxwidth + 'px';
  ...
  mounted(){
    this.maxwidth = this.$refs.dragSupply.clientWidth - this.$refs.moveSupply.clientWidth-3;
