...
<script>
	...
	export default {
		...
		computed: {
			isOverInquiry: function () {
				if(this.OrderList.inquiryEndTime){
					let curr_time = new Date().getTime()
					let inquiry_time = new Date(Date.parse(this.OrderList.inquiryEndTime.replace(/-/g, "/"))).getTime()
          if(curr_time > inquiry_time){
          	return true
          }
        }
				return false
			...
			isOverEnd: function () {
				if(this.OrderList.endTime){
					let curr_time = new Date().getTime()
					let end_time = new Date(Date.parse(this.OrderList.endTime.replace(/-/g, "/"))).getTime()
